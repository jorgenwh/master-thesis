...
\begin{tikzpicture}
  ...
  % arrows
  \draw [double distance=.75pt](6.65,-.8) -- (6.65,-1.5);
  \draw [double distance=.75pt](6.65,-1.5) -- (1.25,-1.5);
  \draw [double distance=.75pt,->](1.25,-1.5) -- (1.25,-2.2);
  % kmer counting 
  ...
  \draw [double distance=.75pt,->](2.5,-3) -- (4.15,-3);
  ...
  % arrows
  \draw [double distance=.75pt](5.375,-3.8) -- (5.375,-4.5);
  \draw [double distance=.75pt](5.375,-4.5) -- (1.25,-4.5);
  \draw [double distance=.75pt,->](1.25,-4.5) -- (1.25,-5.2);
  % genotyping
  ...
  \draw [double distance=.75pt,->](2.5,-6) -- (4.15,-6);
