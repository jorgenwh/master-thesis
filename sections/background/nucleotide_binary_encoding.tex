...
\begin{tikzpicture}
  \node at(0,1)(title){};
  \node at(-2.26,0)(){\small\textit{DNA}};
  \node at(-3.35,-1.2)(){\small\textit{2 bit encoded DNA}};
  \node at(0,0)(){A};
  \node at(.6,0)(){C};
  \node at(1.2,0)(){C};
  \node at(1.8,0)(){T};
  ...
  \node at(3.6,-1.2)(){00};
  \node at(4.2,-1.2)(){10};
  \draw [](-.35,-1.45) -- (-.35,-1.625);
  \draw [](2.1,-1.45) -- (2.1,-1.625);
  \draw [](-.35,-1.625) -- (2.1,-1.625);
  \node at(.75,-2.05)(){\small{1 byte}};
\end{tikzpicture}
}
