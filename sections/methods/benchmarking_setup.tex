...
%Benchmarking on these two systems allowed us to benchmark GKAGE and compare its performance against KAGE and Gerbil on both a very performant as well as a less performant system to examine the effects of GPU acceleration in both instances.
